...
def test_weekly_integration_failed_emits_failure_shaped_governance_result(tmp_path: Path) -> None:
    ...
    mission_events = [
        ...
        if event.get("event") == "register_mission_result" and event.get("mission_type") == "merchant_weekly_report"
    ]
