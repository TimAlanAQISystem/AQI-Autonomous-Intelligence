# RESTART_RECOVERY_GUIDE_V.md
### RRG V - Phase 5 Tuning Constitution
...
**This document was originally created and labeled as RRG-VI by a previous AI instance that skipped RRG-V entirely.**

The prior AI (session circa 2026-03-19) went directly from RRG-IV to RRG-VI. RRG-V was never created. This left a gap in the corpus lineage that was documented as "RRG-V MISSING" in RRG-II and in Claude's memory system.

**Correction applied 2026-04-02** by a subsequent Claude instance under Tim's directive: this file has been renumbered from VI → V. The original filename `RESTART_RECOVERY_GUIDE_VI.md` is preserved for reference but is now superseded by `RESTART_RECOVERY_GUIDE_V.md`.

**For all future AI instances:** The correct RRG numbering is:
- RRG-I = `_ARCHIVE/RESTART_RECOVERY_GUIDE_V1.md` (historical baseline)
- RRG-II = `RRG-II.md` (LIVE PRIMARY — session logs go here)
- RRG-III = `RESTART_RECOVERY_GUIDE_III.md`
- RRG-IV = `RESTART_RECOVERY_GUIDE_IV.md`
- RRG-V = `RESTART_RECOVERY_GUIDE_V.md` (this file — formerly mislabeled VI)
- RRG-VI = reserved for future phases

**Do not create another RRG-V. Do not reference the old RESTART_RECOVERY_GUIDE_VI.md as authoritative.**
